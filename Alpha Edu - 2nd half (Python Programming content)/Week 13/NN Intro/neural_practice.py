...
#!batch_size=64, 
train_loader = DataLoader(train_dataset, batch_size=90, shuffle=True)  # Для обучения
test_loader = DataLoader(test_dataset, batch_size=90, shuffle=False)  # Для тестирования
...
class SimpleNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc1 = nn.Linear(28 * 28, 128)  # Входной слой: 28x28 -> 128 узлов 1
...
optimizer = optim.SGD(model.parameters(), lr=0.1)  # Оптимизатор SGD (градиентный спуск)
...
def evaluate_model(model, test_loader):
    ...
    correct = 0 # CORRECTLY PREDICTED IMAGES
